...
def load_dataset(dataset_path,N_examples,N_traingdata):
    ...
    for n in tqdm.tqdm(range(0,N_examples)):
        ...
        labelset.append(lab[:,:,0:NUM_OF_CLASSESS])
...
def main(argv=None):
    ...
    annotation = tf.placeholder(tf.float32, shape=[None, IMSIZE_X, IMSIZE_Y, NUM_OF_CLASSESS], name="annotation")
    ...
    data = load_dataset(FLAGS.data_dir,N_EXAMPLE,N_TRAINING_DATA)
